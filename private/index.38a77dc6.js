...
const REFER_CONTRACT_ADDRESS_TESTNET =
    ...
    REFER_CONTRACT_ADDRESS_MAINNET = "0x4ce1f912E06211095633961fd542E2455580721d",
...
function atLogin() {
    ...
    let t = `https://seed.battleinfinity.io/?refercode=${e}`;
...
async function updateBNBRaised() {
    ...
    let t = "";
    try {
        t = percentageOfBNBRaised(e, 1200);
    } catch (e) {
